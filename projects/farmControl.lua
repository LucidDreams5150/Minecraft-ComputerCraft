...
local mainMenuLabels = {"Essence", "Crops", "Passive Mobs", "Hostile Mobs", "Other Farms"}
--ESSENCE MENU -- use these as headers too
local essenceMenuLabels = {"Mob Essence", "Element Essence", "Resource Essence", "Other"}
--Mob Essence
local mobEssenceMenuLabels = {"Creeper", "Wither Skeleton"}
--Element Essence
local elementEssenceMenuLabels = {"Air", "Water", "Earth", "Fire", "Dirt", "Nature"}
--Resource Essence
local resourceEssenceMenuLabels = {"Uranium", "Fluorite", "Sulfur", "Inferium"}
--CROPS MENU
local cropMenuLabels = {"Wheat", "Potatoes", "Carrots"}
--MOBS
local mobsMenuLabels = {"Passive", "Hostile"}
--Passive Mobs
local passiveMobMenuLabels = {"Pig", "Cow", "Sheep", "Chicken"}
--Hostile Mob
local hostileMobMenuLabels = {"Wither Skeleton", "Creeper", "Cave Creeper", "Witch", "Warden"}
--Other Menu
local otherFarmMenuLabels = {}
--**END LABEL TABELS**--

local mainMenu = basalt.createFrame()
local basbutton = mainMenu:addButton():setText("Basalt Button"):setPosition(25,25):onClick(function() basalt.debug("Click me again")end)
basalt.autoUpdate()

--Button instances create--
...
--Fills in blank space top center with background color and banner label
...
buttonGrid:add("Previous",nil,1,1,11,3,colors.red, colors.lime)
