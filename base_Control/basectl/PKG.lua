local PKG = { files = {} }PKG.files["/basectl/main.lua"] = [=[-- main.lua  v0.6.1
...
main()
]=]PKG.files["/basectl/page_stats.lua"] = [=[-- page_stats.lua  v0.2.0
...
return M
]=]PKG.files["/basectl/server.lua"] = [=[-- server.lua  v0.4.1
...
return M
]=]PKG.files["/basectl/page_server.lua"] = [=[-- page_server.lua  v0.1.0
...
return M
]=]PKG.files["/basectl/util.lua"] = [=[-- util.lua  v0.4.1
local M = {}
...
return M
]=]PKG.files["/basectl/page_labels.lua"] = [=[-- page_labels.lua  v0.5.5
...
return M
]=]PKG.files["/basectl/page_utils.lua"] = [=[-- page_utils.lua  v0.1.0
...
return M
]=]PKG.files["/basectl/ui.lua"] = [=[-- ui.lua  v0.5.0
...
return M
]=]PKG.files["/basectl/store.lua"] = [=[-- store.lua  v0.3.0
